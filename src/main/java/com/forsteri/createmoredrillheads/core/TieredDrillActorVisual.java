...
public class TieredDrillActorVisual extends ActorVisual {
    ...
    public TieredDrillActorVisual(VisualizationContext visualizationContext, VirtualRenderWorld contraption, MovementContext context) {
